    ...
    <nav id="nav" className="nav">
      <ul>
        <li className="active item" id="HomeNav">
          ...
          <p className="titleNav" style={{color:"white"}}>{t("Home")}</p>
        </li>
        <li className="item" id="GroupNav">
          ...
          <p className="titleNav"style={{color:"white"}}> {t("Group")}</p>
        </li>
        <li className="item" id="summaryBank">
          ...
          <p className="titleNav"style={{color:"white"}}> {t("Summary Bank")}</p>
        </li>
        <li className="item" id="settingNav">
          ...
          <p className="titleNav"style={{color:"white"}}>{t("Settings")} </p>
        </li>
        <Link to={`Profile/${id}`}>
          <li className={`item`}>
            <svg
            ...
            <p className="titleNav"style={{color:"white"}}>{t("Profile")}</p>
          </li>
        </Link>
      </ul>
    </nav>

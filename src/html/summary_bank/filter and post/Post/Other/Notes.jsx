    ...
    <div className="Notes" dir={i18n.language === "en" ? "ltr" : "rtl"}>
      <div className="NoteItem">
        <p>
          <span>*</span>{" "}
          {t(
            "Make sure to enter all the information, as all fields are required.",
          )}
        </p>
        <p>
          <span>*</span>{" "}
          {t("Any summary submitted will be reviewed before approval.")}
        </p>
        <p>
        ...
        <p>
          <span>*</span>{" "}
          {t(
            "Any document published and approved will earn you contribution points",
          )}
          <span> {t(" (each published file = 3 contribution points)")}</span>
        </p>
      </div>
      <div className="contact">
        <a href="mailto:abduillh160@gmail.com">
          <svg
        ...
        <a title={t("admin Nana")} href="https://t.me/MAKI20020">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <a title={t("admin Rossevelt")} href="https://t.me/Rossevelt_1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
